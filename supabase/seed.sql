...
('coentro-organico','Coentro Orgânico','Não tem comida baiana sem coentro. Aroma intenso, folhas fresquinhas.',3.00,1.00,'maço','temperos','',45,true,false),
...
('couve-manteiga-organica','Couve Manteiga Orgânica','Folhas macias para o acarajé, o caruru e o suco verde de todo dia.',4.00,1.40,'maço','verduras','',42,true,false),
